...
const companyPages = [
  {
    _type: 'companyPage',
    pageType: 'about',
    title: 'About MovingWalls',
    subtitle: 'Transforming How Brands Reach Real People',
    heroDescription: 'MovingWalls is a global connected media and programmatic out of home company powered by US patented measurement technology. We help brands reach real people in real places with precision, accountability, and confidence.',
    mission: 'At MovingWalls, we believe advertising should be more than just reaching audiences—it should create meaningful connections. Our mission is to empower brands with intelligent, data-driven advertising solutions that deliver measurable results and drive real business growth.',
  ...
  },
  {
    ...
    heroDescription: 'From a bold vision to market leadership, discover how MovingWalls transformed the advertising landscape through innovative technology and unwavering commitment to client success.',
    mission: 'At MovingWalls, we believe advertising should be more than just reaching audiences—it should create meaningful connections. Our mission is to empower brands with intelligent, data-driven advertising solutions that deliver measurable results and drive real business growth.',
