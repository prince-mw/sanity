...
const pressReleasesData = [
  {
    ...
    content: [
      { _type: 'block', style: 'normal', children: [{ _type: 'span', text: 'Moving Walls, a leading out-of-home (OOH) advertising technology company, today announced the launch of its revolutionary AI-Powered Audience Targeting Platform, designed to transform how brands reach their target audiences through outdoor advertising.' }] },
  ...
  },
  {
    ...
    content: [
      { _type: 'block', style: 'normal', children: [{ _type: 'span', text: 'Moving Walls today announced the successful completion of a $50 million Series C funding round, marking a significant milestone in the company\'s growth trajectory.' }] },
      { _type: 'block', style: 'h2', children: [{ _type: 'span', text: 'Investment Details' }] },
      { _type: 'block', style: 'normal', children: [{ _type: 'span', text: 'The funding round was led by prominent venture capital firms, with participation from existing investors who continue to show strong confidence in Moving Walls\' vision and execution.' }] },
  ...
  },
  {
    ...
    content: [
      { _type: 'block', style: 'normal', children: [{ _type: 'span', text: 'Moving Walls has announced a landmark partnership with a major global transit authority network, significantly expanding its out-of-home advertising footprint.' }] },
      { _type: 'block', style: 'h2', children: [{ _type: 'span', text: 'Partnership Scope' }] },
      { _type: 'block', style: 'normal', children: [{ _type: 'span', text: 'This strategic alliance will bring Moving Walls\' cutting-edge advertising technology to 25 new metropolitan areas, reaching millions of daily commuters across multiple continents.' }] },
  ...
  },
  {
    ...
    content: [
      { _type: 'block', style: 'normal', children: [{ _type: 'span', text: 'Moving Walls has been named "AdTech Company of the Year" at the prestigious Industry Awards ceremony, recognizing the company\'s exceptional contributions to advertising technology innovation.' }] },
      { _type: 'block', style: 'h2', children: [{ _type: 'span', text: 'Award Recognition' }] },
      { _type: 'block', style: 'normal', children: [{ _type: 'span', text: 'The award specifically highlighted Moving Walls\' groundbreaking work in programmatic advertising and measurement solutions for the out-of-home sector.' }] },
  ...
  },
  {
    ...
    content: [
      { _type: 'block', style: 'normal', children: [{ _type: 'span', text: 'Moving Walls today unveiled its new Privacy-First Measurement Suite, a comprehensive solution designed to help brands navigate the complex landscape of data privacy regulations while maintaining campaign effectiveness.' }] },
  ...
  },
  {
    ...
    content: [
      { _type: 'block', style: 'normal', children: [{ _type: 'span', text: 'Moving Walls has officially opened its European headquarters in London, marking a significant expansion of the company\'s global presence.' }] },
...
const mediaFeaturesData = [
  {
    ...
    excerpt: "An in-depth look at how Moving Walls is transforming the out-of-home advertising industry with innovative technology solutions.",
    readTime: "5 min read",
    isMediaFeature: true,
    externalLink: "https://www.adweek.com",
    content: [
      { _type: 'block', style: 'normal', children: [{ _type: 'span', text: 'AdWeek takes an in-depth look at Moving Walls and its mission to revolutionize the out-of-home advertising industry through technology and innovation.' }] },
  ...
  },
  {
    ...
    content: [
      { _type: 'block', style: 'normal', children: [{ _type: 'span', text: 'TechCrunch explores the rapidly evolving landscape of programmatic advertising, featuring insights from Moving Walls on the future of automated ad buying and selling.' }] },
    ]
  },
  {
    ...
    content: [
      { _type: 'block', style: 'normal', children: [{ _type: 'span', text: 'Marketing Land sits down with Moving Walls\' CEO for an exclusive interview about the company\'s vision for the future of advertising technology.' }] },
  ...
  },
  {
    ...
    category: "award",
    excerpt: "Forbes recognizes Moving Walls as one of the top 50 most innovative companies in the advertising technology sector.",
    readTime: "3 min read",
    isMediaFeature: true,
    externalLink: "https://www.forbes.com",
    content: [
      { _type: 'block', style: 'normal', children: [{ _type: 'span', text: 'Forbes has recognized Moving Walls as one of the Top 50 Most Innovative Companies in the advertising technology sector, highlighting the company\'s breakthrough approaches to out-of-home advertising.' }] },
    ]
  }
]
  ...
  for (const item of allPressData) {
    try {
      ...
      const doc = {
        ...
        source: item.source || 'Moving Walls',
