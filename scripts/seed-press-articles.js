...
const pressArticles = [
  {
    ...
    content: [
      { _type: 'block', _key: 'intro', style: 'normal', markDefs: [], children: [
        { _type: 'span', _key: 'intro1', text: 'NEW YORK, NY - November 15, 2024 - MovingWalls, the leading advertising technology platform, today announced the launch of its revolutionary AI-powered audience targeting platform, marking a significant milestone in programmatic advertising innovation.', marks: [] }
      ]},
      ...
      { _type: 'block', _key: 'p2', style: 'normal', markDefs: [], children: [
        { _type: 'span', _key: 'p2a', text: '"This launch represents years of research and development in artificial intelligence and machine learning," said Sarah Chen, Chief Technology Officer at MovingWalls. "Our AI platform doesn\'t just analyze demographics—it understands behavioral patterns, contextual signals, and real-time intent to deliver the right message to the right person at precisely the right moment."', marks: [] }
      ]},
  ...
  },
  {
    ...
    content: [
      { _type: 'block', _key: 'intro', style: 'normal', markDefs: [], children: [
        { _type: 'span', _key: 'intro1', text: 'NEW YORK, NY - October 28, 2024 - MovingWalls, the rapidly growing advertising technology platform, today announced the successful completion of its $50 million Series C funding round, led by Sequoia Capital with participation from existing investors Andreessen Horowitz, GV (Google Ventures), and new investor Accel Partners.', marks: [] }
      ]},
      { _type: 'block', _key: 'p1', style: 'normal', markDefs: [], children: [
        { _type: 'span', _key: 'p1a', text: 'This latest funding round brings MovingWalls\'s total capital raised to $120 million and values the company at $800 million, representing a significant milestone in the company\'s journey to transform the advertising technology landscape.', marks: [] }
      ]},
      { _type: 'block', _key: 'h1', style: 'h2', markDefs: [], children: [
        { _type: 'span', _key: 'h1a', text: 'Fueling Global Expansion', marks: [] }
      ]},
      { _type: 'block', _key: 'p2', style: 'normal', markDefs: [], children: [
        { _type: 'span', _key: 'p2a', text: 'The Series C funding will primarily support MovingWalls\'s aggressive international expansion plans, with immediate focus on establishing stronger presence in European and Asian markets. The company plans to open new offices in Berlin, Tokyo, and Sydney by Q2 2025, while significantly expanding its existing London and Singapore operations.', marks: [] }
      ]},
      { _type: 'block', _key: 'quote', style: 'normal', markDefs: [], children: [
        { _type: 'span', _key: 'q1', text: '"This investment validates our vision of creating the most intelligent and effective advertising platform in the world," said David Kim, CEO and Co-founder of MovingWalls. "The funding will accelerate our global expansion and allow us to bring our innovative solutions to advertisers and publishers worldwide."', marks: [] }
      ]},
      { _type: 'block', _key: 'h2', style: 'h2', markDefs: [], children: [
        { _type: 'span', _key: 'h2a', text: 'Strategic Investment Leadership', marks: [] }
      ]},
      { _type: 'block', _key: 'p3', style: 'normal', markDefs: [], children: [
        { _type: 'span', _key: 'p3a', text: 'Sequoia Capital\'s decision to lead the round reflects confidence in MovingWalls\'s market position and growth trajectory. Partner Amanda Chen from Sequoia Capital will join MovingWalls\'s board of directors, bringing extensive experience in scaling technology companies globally.', marks: [] }
      ]},
      { _type: 'block', _key: 'h3', style: 'h2', markDefs: [], children: [
  ...
  },
  {
    ...
    content: [
      { _type: 'block', _key: 'intro', style: 'normal', markDefs: [], children: [
        { _type: 'span', _key: 'intro1', text: 'NEW YORK, NY - August 5, 2024 - MovingWalls has been named \'AdTech Company of the Year\' at the prestigious Digital Marketing Excellence Awards, recognizing the company\'s outstanding innovation in programmatic advertising and measurement solutions.', marks: [] }
      ]},
      { _type: 'block', _key: 'p1', style: 'normal', markDefs: [], children: [
      ...
      { _type: 'block', _key: 'p3', style: 'normal', markDefs: [], children: [
        { _type: 'span', _key: 'p3a', text: '"This award is a testament to our team\'s dedication to innovation and our clients\' success," said David Kim, CEO of MovingWalls. "We\'re honored to be recognized by our peers and remain committed to pushing the boundaries of what\'s possible in advertising technology."', marks: [] }
      ]},
    ],
  },
  {
    ...
    content: [
      { _type: 'block', _key: 'intro', style: 'normal', markDefs: [], children: [
        { _type: 'span', _key: 'intro1', text: 'LONDON, UK - June 18, 2024 - MovingWalls today announced the opening of its European headquarters in London\'s prestigious Canary Wharf district, marking a significant milestone in the company\'s international expansion strategy.', marks: [] }
      ]},
      { _type: 'block', _key: 'p1', style: 'normal', markDefs: [], children: [
        { _type: 'span', _key: 'p1a', text: 'The new 25,000 square foot office will serve as the regional hub for MovingWalls\'s European operations, housing teams focused on sales, client services, product development, and regulatory compliance across the European market.', marks: [] }
      ]},
      { _type: 'block', _key: 'h1', style: 'h2', markDefs: [], children: [
        { _type: 'span', _key: 'h1a', text: 'Strategic Location', marks: [] }
      ]},
      { _type: 'block', _key: 'p2', style: 'normal', markDefs: [], children: [
        { _type: 'span', _key: 'p2a', text: 'Located at 40 Bank Street in Canary Wharf, the new headquarters positions MovingWalls at the heart of London\'s financial and technology district. The location provides easy access to major European markets and places the company alongside other leading global technology firms.', marks: [] }
      ]},
      { _type: 'block', _key: 'quote', style: 'normal', markDefs: [], children: [
        { _type: 'span', _key: 'q1', text: '"London is the perfect base for our European expansion," said David Kim, CEO of MovingWalls. "The city\'s position as a global financial center, combined with its thriving tech ecosystem and access to top talent, makes it an ideal location for our regional headquarters."', marks: [] }
      ]},
      { _type: 'block', _key: 'h2', style: 'h2', markDefs: [], children: [
        { _type: 'span', _key: 'h2a', text: 'Team Expansion', marks: [] }
      ]},
      { _type: 'block', _key: 'p3', style: 'normal', markDefs: [], children: [
        { _type: 'span', _key: 'p3a', text: 'The London office officially opened with a team of 50 employees and plans to expand to 150 staff members by the end of 2024. Leading the European operations is Emma Richardson, who joins MovingWalls as VP of European Operations.', marks: [] }
      ]},
      { _type: 'block', _key: 'h3', style: 'h2', markDefs: [], children: [
        { _type: 'span', _key: 'h3a', text: 'Market Opportunity', marks: [] }
      ]},
      { _type: 'block', _key: 'p4', style: 'normal', markDefs: [], children: [
        { _type: 'span', _key: 'p4a', text: 'The European digital advertising market represents significant growth opportunity for MovingWalls, with programmatic advertising spend expected to reach €45 billion by 2025. The company\'s privacy-first approach and GDPR-compliant solutions position it well to serve European brands and agencies.', marks: [] }
      ]},
    ],
  },
  {
    ...
    isPublished: true,
    status: 'published',
    excerpt: 'Major partnership expands MovingWalls\'s out-of-home advertising network to 25 new metropolitan areas, reaching over 100 million daily commuters worldwide.',
    content: [
      { _type: 'block', _key: 'intro', style: 'normal', markDefs: [], children: [
        { _type: 'span', _key: 'intro1', text: 'NEW YORK, NY - September 12, 2024 - MovingWalls today announced a landmark partnership with the Global Transit Authority Network (GTAN), significantly expanding its out-of-home advertising capabilities across 25 major metropolitan areas worldwide.', marks: [] }
      ]},
      { _type: 'block', _key: 'p1', style: 'normal', markDefs: [], children: [
        { _type: 'span', _key: 'p1a', text: 'This strategic alliance will provide MovingWalls with exclusive advertising access to premium transit locations including subway systems, bus networks, and transit hubs in cities across North America, Europe, and Asia, reaching an estimated 100 million daily commuters.', marks: [] }
      ]},
      { _type: 'block', _key: 'h1', style: 'h2', markDefs: [], children: [
      ...
      { _type: 'block', _key: 'p3', style: 'normal', markDefs: [], children: [
        { _type: 'span', _key: 'p3a', text: 'As part of this partnership, MovingWalls will deploy state-of-the-art digital displays throughout the transit network, featuring dynamic content capabilities and real-time optimization based on passenger flow, weather conditions, and local events.', marks: [] }
      ]},
      { _type: 'block', _key: 'quote', style: 'normal', markDefs: [], children: [
