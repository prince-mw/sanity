...
export default function IntegrationsPageClient({ integrations }: IntegrationsPageClientProps) {
  ...
  const categories = [
    ...
    { id: 'ssp', name: 'SSP Partners', count: sspCount },
    { id: 'dsp', name: 'DSP Partners', count: dspCount },
  ]
                      ...
                      <div className="w-14 h-14 bg-gray-50 rounded-xl flex items-center justify-center group-hover:bg-blue-50 transition-colors p-2">
                        {integration.logo ? (
                          ...
                          <div className="w-10 h-10 bg-blue-100 rounded-lg flex items-center justify-center">
                            <span className="text-blue-600 font-bold text-lg">{integration.name.charAt(0)}</span>
                          </div>
                        )}
                      </div>
                      <div className="flex items-center gap-1 bg-green-100 text-green-700 px-2 py-1 rounded-full text-xs font-medium">
                        <div className="w-1.5 h-1.5 bg-green-500 rounded-full"></div>
                        {integration.status === 'live' ? 'Live' : integration.status}
                      </div>
                    </div>
                  ...
                  <div className="w-16 h-16 bg-white rounded-xl shadow-sm flex items-center justify-center p-2">
                    {selectedIntegration.logo ? (
                      ...
                      <div className="w-12 h-12 bg-blue-100 rounded-lg flex items-center justify-center">
                        <span className="text-blue-600 font-bold text-xl">{selectedIntegration.name.charAt(0)}</span>
                      </div>
                    )}
                  </div>
                  <div>
