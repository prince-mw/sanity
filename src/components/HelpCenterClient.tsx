...
const defaultFaqData: HelpCenterFaq[] = [
  {
...
export default function HelpCenterClient({ faqs }: HelpCenterClientProps) {
  const [searchQuery, setSearchQuery] = useState("");
  const [selectedCategory, setSelectedCategory] = useState("All");

  const faqData = faqs?.length ? faqs : defaultFaqData;
