          ...
          {isClient && (
            ...
            >
              <defs>
                ...
                <radialGradient id="ecosystemCyanComet" cx="50%" cy="50%" r="50%">
                  <stop offset="0%" stopColor="#22D3EE" stopOpacity="1" />
                  <stop offset="60%" stopColor="#22D3EE" stopOpacity="0.4" />
                  <stop offset="100%" stopColor="#22D3EE" stopOpacity="0" />
                </radialGradient>
                {/* Comet head gradient - purple */}
                <radialGradient id="ecosystemPurpleComet" cx="50%" cy="50%" r="50%">
              ...
              <circle cx="500" cy="235" r="60" fill="#3B82F6" opacity="0.08" filter="url(#ecosystemHubGlow)">
              ...
              <g>
                ...
                <circle cx="552" cy="235" r="3" fill="#22D3EE" opacity="0.8" filter="url(#ecosystemDotGlow)" />
              </g>
              <g>
                <animateTransform attributeName="transform" type="rotate" values="360 500 235;0 500 235" dur="12s" repeatCount="indefinite" />
                <circle cx="500" cy="179" r="2.5" fill="#A855F7" opacity="0.6" filter="url(#ecosystemDotGlow)" />
              </g>
              <g>
                ...
                <circle cx="455" cy="235" r="2" fill="#3B82F6" opacity="0.5" filter="url(#ecosystemDotGlow)" />
              </g>
              ...
              {[
                ...
                <circle key={`eco-ambient-${i}`} r={1 + (i % 3) * 0.3} fill={['#22D3EE', '#3B82F6', '#A855F7'][i % 3]} opacity="0">
              ...
              {[115, 145, 175, 205, 235, 265, 295, 325, 355].map((y, i) => (
                <g key={`left-conn-${i}`}>
                  ...
                  <circle r="5" fill="url(#ecosystemCyanComet)" filter="url(#ecosystemDotGlow)">
                    <animateMotion
                      dur={`${3 + i * 0.3}s`}
              ...
              {[115, 145, 175, 205, 235, 265, 295, 325, 355].map((y, i) => (
                <g key={`right-conn-${i}`}>
                  ...
                  />
                  {/* Lead particle with comet glow */}
                  <circle r="5" fill="url(#ecosystemPurpleComet)" filter="url(#ecosystemDotGlow)">
                    <animateMotion
                      dur={`${3 + i * 0.3}s`}
                      repeatCount="indefinite"
                      begin={`${i * 0.4 + 1.5}s`}
