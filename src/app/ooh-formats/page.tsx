...
const fallbackOohFormats: OOHFormat[] = [
  ...
  },
  {
    ...
    category: "Digital Out-of-Home (DOOH)",
    icon: "led",
    description: "These synchronous, multi-panel displays line public streets - either on the sides or right along the middle.",
  ...
  },
  {
    ...
    category: "Digital Out-of-Home (DOOH)",
    icon: "billboard",
    description: "Overhead bridges have the size and strength to support massive screens spanning the entire width of the road.",
  ...
  },
  {
    ...
    icon: "transit",
    description: "This is an incredible, dynamic DOOH format that not only allows you to place an ad where your target audience is but also lets you follow them around.",
  ...
  },
  {
    ...
    icon: "airport",
    description: "Airports are filled with people who are waiting for something - a captive audience that's literally looking around for things to occupy their time.",
  ...
  },
  {
    ...
    category: "Digital Out-of-Home (DOOH)",
    icon: "digital",
    description: "Large billboards on the side of highways and heavy-traffic roads, these massive billboards tower over their surroundings.",
  ...
  },
  {
    ...
    icon: "spectacular",
    description: "Nothing beats a large screen in a closed room where people have come in with the intention of watching that very screen.",
