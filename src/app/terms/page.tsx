...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    alternates: {
      canonical: "https://www.movingwalls.com/terms",
    },
                    ...
                    <div className="pl-11 space-y-6">
                      <div className="bg-gray-50 rounded-xl p-6">
                        ...
                        <div className="space-y-4 text-gray-600 leading-relaxed">
                          ...
                          <p>
                            Moving Walls&apos;s inventory count and Moving Walls&apos;s record of the price per inventory will be controlling and final. Any complaints relating to an invoice must be submitted to Moving Walls in writing or by email to <span className="text-mw-blue-600 font-medium">info@movingwalls.com</span> within two weeks upon receipt of the invoice. If no such complaint has been made within two weeks upon receipt of invoice, the invoice is deemed to be accepted.
                          </p>
