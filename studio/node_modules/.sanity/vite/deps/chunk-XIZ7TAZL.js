...
function MotionConfig({ children, isValidProp, ...config }) {
  ...
  const parentConfig = (0, import_react12.useContext)(MotionConfigContext);
  config = { ...parentConfig, ...config };
  config.transition = resolveTransition(config.transition, parentConfig.transition);
  config.isStatic = useConstant(() => config.isStatic);
  const context2 = (0, import_react12.useMemo)(() => config, [
    JSON.stringify(config.transition),
    config.transformPagePoint,
    config.reducedMotion,
    config.skipAnimations
  ]);
  return (0, import_jsx_runtime4.jsx)(MotionConfigContext.Provider, { value: context2, children });
}
...
function useMotionRef(visualState, visualElement, externalRef) {
  const externalRefContainer = (0, import_react21.useRef)(externalRef);
  (0, import_react21.useInsertionEffect)(() => {
    externalRefContainer.current = externalRef;
  });
  const refCleanup = (0, import_react21.useRef)(null);
...
function useVisualElement(Component4, visualState, props, createVisualElement, ProjectionNodeConstructor, isSVG2) {
  ...
  const motionConfig = (0, import_react23.useContext)(MotionConfigContext);
  const reducedMotionConfig = motionConfig.reducedMotion;
  const skipAnimations = motionConfig.skipAnimations;
  const visualElementRef = (0, import_react23.useRef)(null);
  const hasMountedOnce = (0, import_react23.useRef)(false);
  ...
  const wantsHandoff = (0, import_react23.useRef)(Boolean(optimisedAppearId) && typeof window !== "undefined" && !((_a = window.MotionHandoffIsComplete) == null ? void 0 : _a.call(window, optimisedAppearId)) && ((_b = window.MotionHasOptimisedAnimation) == null ? void 0 : _b.call(window, optimisedAppearId)));
  useIsomorphicLayoutEffect(() => {
...
var LazyRefractor = (0, import_react54.lazy)(() => import("./refractor-QDWBGLCF.js"));
...
react-is/cjs/react-is.development.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-XIZ7TAZL.js.map
