...
import {
  ...
  useEffectEvent,
  useFloating
} from "./chunk-I4FQ6NQZ.js";
import {
  require_react_dom
} from "./chunk-UV3OTT5T.js";
import {
  CheckmarkIcon,
  ChevronDownIcon,
  ChevronRightIcon,
...
function generateUrlSecret() {
  if (typeof crypto < "u") {
    ...
    for (let i = 0; i < array.length; i++)
      key2 += array[i].toString(16).padStart(2, "0");
    return key2 = btoa(key2).replace(/\+/g, "-").replace(/\//g, "_").replace(/[=]+$/, ""), key2;
  }
...
function definePreviewUrl(options) {
  const {
    draftMode,
    previewMode,
    origin: origin2 = typeof location > "u" ? "https://localhost" : location.origin
  } = options, enableUrl = (previewMode == null ? void 0 : previewMode.enable) || (draftMode == null ? void 0 : draftMode.enable);
  let { preview = "/" } = options;
  const productionUrl = new URL(preview, origin2), enablePreviewModeUrl = enableUrl ? new URL(enableUrl, origin2) : void 0;
...
// node_modules/sanity-plugin-iframe-pane/node_modules/@sanity/ui/dist/theme.mjs
var colors = {
  default: {
    lightest: "hsl(0, 0%, 95%)",
    lighter: "hsl(0, 0%, 70%)",
...
// node_modules/sanity-plugin-iframe-pane/node_modules/@sanity/ui/dist/_chunks-es/_visual-editing.mjs
...
function responsiveFont(fontKey, props) {
  const {
    ...
    sizes: sizes2,
    weights
  } = font[fontKey], fontWeight = $weight && weights[$weight] || weights.regular, defaultSize = sizes2[2], base = {
    position: "relative",
    fontFamily: family,
  ...
  const resp = _responsive(media, $size, (sizeIndex) => fontSize(sizes2[sizeIndex] || defaultSize));
  return [base, ...resp];
}
...
function ThemeProvider(props) {
  ...
  let t2;
  $[9] !== children || $[10] !== theme ? (t2 = (0, import_jsx_runtime.jsx)(Qe, { theme, children }), $[9] = children, $[10] = theme, $[11] = t2) : t2 = $[11];
  let t3;
...
function useTheme_v2() {
  const $ = (0, import_react_compiler_runtime.c)(2), t0 = Ke();
  let t1;
...
var LazyRefractor = (0, import_react.lazy)(() => import("./refractor-5RLZH2EE.js"));
...
var Arrow = (0, import_react.forwardRef)(function(props, ref) {
  ...
  let t8;
  return $[24] !== ref || $[25] !== restProps || $[26] !== t7 || $[27] !== w ? (t8 = (0, import_jsx_runtime.jsx)(StyledArrow, { ...restProps, $w: w, ref, children: t7 }), $[24] = ref, $[25] = restProps, $[26] = t7, $[27] = w, $[28] = t8) : t8 = $[28], t8;
});
...
function LayerProvider(props) {
  ...
  let t4, t5;
  $[6] !== level || $[7] !== parentRegisterChild ? (t4 = () => parentRegisterChild == null ? void 0 : parentRegisterChild(level), t5 = [level, parentRegisterChild], $[6] = level, $[7] = parentRegisterChild, $[8] = t4, $[9] = t5) : (t4 = $[8], t5 = $[9]), (0, import_react.useEffect)(t4, t5);
  let t6;
...
var VirtualList = (0, import_react.forwardRef)(function(props, forwardedRef) {
  ...
  let t14;
  return $[52] !== as || $[53] !== restProps || $[54] !== t13 ? (t14 = (0, import_jsx_runtime.jsx)(StyledVirtualList, { as, "data-ui": "VirtualList", ...restProps, ref, children: t13 }), $[52] = as, $[53] = restProps, $[54] = t13, $[55] = t14) : t14 = $[55], t14;
});
...
var Tooltip = (0, import_react.forwardRef)(function(props, forwardedRef) {
  ...
  (0, import_react.useImperativeHandle)(forwardedRef, () => ref.current);
  const portal = usePortal(), portalElement = typeof portalProp == "string" ? ((_a = portal.elements) == null ? void 0 : _a[portalProp]) || null : portal.element, middleware = (0, import_react.useMemo)(() => {
    const ret = [];
  ...
  }, [childProp == null ? void 0 : childProp.props, handleIsOpenChange]), handleClick = (0, import_react.useCallback)((e_0) => {
    var _a2, _b2;
    handleIsOpenChange(false, true), (_b2 = childProp == null ? void 0 : (_a2 = childProp.props).onClick) == null ? void 0 : _b2.call(_a2, e_0);
  }, [childProp == null ? void 0 : childProp.props, handleIsOpenChange]), handleContextMenu = (0, import_react.useCallback)((e_1) => {
    var _a2, _b2;
    handleIsOpenChange(false, true), (_b2 = childProp == null ? void 0 : (_a2 = childProp.props).onContextMenu) == null ? void 0 : _b2.call(_a2, e_1);
  }, [childProp == null ? void 0 : childProp.props, handleIsOpenChange]), handleFocus = (0, import_react.useCallback)((e_2) => {
    var _a2, _b2;
  ...
  }, [childProp == null ? void 0 : childProp.props, handleIsOpenChange]), handleMouseEnter = (0, import_react.useCallback)((e_3) => {
    var _a2, _b2;
  ...
  }, [childProp == null ? void 0 : childProp.props, handleIsOpenChange]), handleMouseLeave = (0, import_react.useCallback)((e_4) => {
    var _a2, _b2;
...
// node_modules/sanity-plugin-iframe-pane/node_modules/@sanity/ui/dist/index.mjs
...
var DEFAULT_FILTER_OPTION = (query2, option) => option.value.toLowerCase().indexOf(query2.toLowerCase()) > -1;
...
var Breadcrumbs = (0, import_react3.forwardRef)(function(props, ref) {
  ...
  const space = useArrayProp(t0 === void 0 ? 2 : t0), [open, setOpen] = (0, import_react3.useState)(false), expandElementRef = (0, import_react3.useRef)(null), popoverElementRef = (0, import_react3.useRef)(null);
  let t1;
  ...
  bb0: {
    ...
    if (maxLength && len > maxLength) {
      ...
      if ($[11] !== afterLength || $[12] !== beforeLength || $[13] !== len || $[14] !== open || $[15] !== rawItems || $[16] !== space) {
        ...
        let t9;
        $[23] !== space || $[24] !== t8 ? (t9 = (0, import_jsx_runtime2.jsx)(Stack, { as: "ol", overflow: "auto", padding: space, space, children: t8 }), $[23] = space, $[24] = t8, $[25] = t9) : t9 = $[25];
  ...
  if ($[33] !== items || $[34] !== separator || $[35] !== space) {
    let t72;
    $[37] !== separator || $[38] !== space ? (t72 = (item, itemIndex) => (0, import_jsx_runtime2.jsxs)(import_react3.Fragment, { children: [
    ...
    t6 = $[36];
  let t7;
  return $[40] !== ref || $[41] !== restProps || $[42] !== t6 ? (t7 = (0, import_jsx_runtime2.jsx)(StyledBreadcrumbs, { "data-ui": "Breadcrumbs", ...restProps, ref, children: t6 }), $[40] = ref, $[41] = restProps, $[42] = t6, $[43] = t7) : t7 = $[43], t7;
});
...
var DialogCard = (0, import_react3.forwardRef)(function(props, forwardedRef) {
  ...
  const $ = (0, import_react_compiler_runtime2.c)(38), {
    ...
    shadow: shadowProp,
    width: widthProp
  } = props, portal = usePortal(), portalElement = portalProp ? ((_a = portal.elements) == null ? void 0 : _a[portalProp]) || null : portal.element, boundaryElement = useBoundaryElement().element, radius = useArrayProp(radiusProp), shadow = useArrayProp(shadowProp), width = useArrayProp(widthProp), ref = (0, import_react3.useRef)(null), contentRef = (0, import_react3.useRef)(null), layer = useLayer(), {
    isTopLayer
  } = layer, labelId = `${id}_label`, showCloseButton = !!onClose && hideCloseButton === false, showHeader = !!header || showCloseButton;
  let t0;
  $[0] === Symbol.for("react.memo_cache_sentinel") ? (t0 = () => ref.current, $[0] = t0) : t0 = $[0], (0, import_react3.useImperativeHandle)(forwardedRef, t0);
  let t1;
  $[1] === Symbol.for("react.memo_cache_sentinel") ? (t1 = () => contentRef.current, $[1] = t1) : t1 = $[1], (0, import_react3.useImperativeHandle)(forwardedContentRef, t1);
  let t2, t3;
  $[2] !== autoFocus ? (t2 = () => {
    autoFocus && ref.current && focusFirstDescendant(ref.current);
  }, t3 = [autoFocus, ref], $[2] = autoFocus, $[3] = t2, $[4] = t3) : (t2 = $[3], t3 = $[4]), (0, import_react3.useEffect)(t2, t3);
  let t4;
...
var Dialog = (0, import_react3.forwardRef)(function(props, ref) {
  var _a;
...
var Skeleton = (0, import_react3.forwardRef)(function(props, ref) {
...
var TextSkeleton = (0, import_react3.forwardRef)(function(props, ref) {
...
var LabelSkeleton = (0, import_react3.forwardRef)(function(props, ref) {
  const $ = (0, import_react_compiler_runtime2.c)(7);
  let restProps, t0;
  $[0] !== props ? ({
    size: t0,
...
var HeadingSkeleton = (0, import_react3.forwardRef)(function(props, ref) {
  const $ = (0, import_react_compiler_runtime2.c)(7);
  let restProps, t0;
  $[0] !== props ? ({
    size: t0,
...
var CodeSkeleton = (0, import_react3.forwardRef)(function(props, ref) {
  const $ = (0, import_react_compiler_runtime2.c)(7);
  let restProps, t0;
  $[0] !== props ? ({
    size: t0,
...
var TabPanel = (0, import_react3.forwardRef)(function(props, ref) {
...
var Tree = (0, import_react3.memo)((0, import_react3.forwardRef)(function(props, forwardedRef) {
  ...
  const space = t0 === void 0 ? 1 : t0, ref = (0, import_react3.useRef)(null), [focusedElement, setFocusedElement] = (0, import_react3.useState)(null), focusedElementRef = (0, import_react3.useRef)(focusedElement);
  let t1;
  ...
  let t4;
  $[8] === Symbol.for("react.memo_cache_sentinel") ? (t4 = () => ref.current, $[8] = t4) : t4 = $[8], (0, import_react3.useImperativeHandle)(forwardedRef, t4);
  let t5, t6;
  $[9] !== focusedElement ? (t5 = () => {
...
var StyledTreeItem = (0, import_react3.memo)(ct.li.withConfig({
...
var TreeItem = (0, import_react3.memo)(function(props) {
  const {
    ...
    setExpanded,
    setFocusedElement
  } = tree, _id = (0, import_react3.useId)(), id = idProp || _id, itemPath = (0, import_react3.useMemo)(() => path.concat([id || ""]), [id, path]), itemKey = itemPath.join("/"), itemState = tree.state[itemKey], focused = tree.focusedElement === rootRef.current, expanded = (itemState == null ? void 0 : itemState.expanded) === void 0 ? expandedProp : (itemState == null ? void 0 : itemState.expanded) || false, tabIndex = tree.focusedElement && tree.focusedElement === rootRef.current ? 0 : -1, contextValue = (0, import_react3.useMemo)(() => ({
    ...tree,
    level: tree.level + 1,
    path: itemPath
...
function DisplayUrl(props) {
  const truncatedUrl = (0, import_react5.useMemo)(() => {
    const url = getRedirectTo(props.url);
    return `${url.origin === location.origin ? "" : url.origin}${url.pathname}${url.search}`;
  }, [props.url]);
  return (0, import_jsx_runtime3.jsx)(Text, { size: 0, textOverflow: "ellipsis", children: truncatedUrl });
}
var sizes = {
  desktop: {
    width: "100%",
...
function Toolbar(props) {
  const { url, iframeSize, setIframeSize, reloading, showUrl, reloadButton, handleReload } = props, validUrl = url instanceof URL, input = (0, import_react5.useRef)(null), { push: pushToast } = useToast(), [, copy] = useCopyToClipboard();
  return (0, import_jsx_runtime3.jsxs)(import_jsx_runtime3.Fragment, { children: [
    ...
    (0, import_jsx_runtime3.jsx)(Card, { padding: 2, borderBottom: true, children: (0, import_jsx_runtime3.jsxs)(Flex, { align: "center", gap: 2, children: [
      (0, import_jsx_runtime3.jsx)(Flex, { align: "center", gap: 1, children: (0, import_jsx_runtime3.jsx)(
        Tooltip,
        {
          animate: true,
          content: (0, import_jsx_runtime3.jsx)(Text, { size: 1, style: { whiteSpace: "nowrap" }, children: iframeSize === "mobile" ? "Exit mobile preview" : "Preview mobile viewport" }),
          padding: 2,
      ...
      (0, import_jsx_runtime3.jsx)(Box, { flex: 1, children: showUrl && validUrl && (0, import_jsx_runtime3.jsx)(DisplayUrl, { url }) }),
      (0, import_jsx_runtime3.jsxs)(Flex, { align: "center", gap: 1, children: [
        reloadButton ? (0, import_jsx_runtime3.jsx)(
          Tooltip,
          {
            animate: true,
            content: (0, import_jsx_runtime3.jsx)(Text, { size: 1, style: { whiteSpace: "nowrap" }, children: reloading ? "Reloading…" : "Reload" }),
            padding: 2,
            children: (0, import_jsx_runtime3.jsx)(
              Button,
              {
        ...
        (0, import_jsx_runtime3.jsx)(
          ...
          {
            animate: true,
            content: (0, import_jsx_runtime3.jsx)(Text, { size: 1, style: { whiteSpace: "nowrap" }, children: "Copy URL" }),
            padding: 2,
            children: (0, import_jsx_runtime3.jsx)(
              Button,
              {
        ...
        (0, import_jsx_runtime3.jsx)(
          ...
          {
            animate: true,
            content: (0, import_jsx_runtime3.jsx)(Text, { size: 1, style: { whiteSpace: "nowrap" }, children: "Open URL in a new tab" }),
            padding: 2,
...
function useCopyToClipboard() {
  const [copiedText, setCopiedText] = (0, import_react5.useState)(null), copy = (0, import_react5.useCallback)(async (text) => {
...
var MotionFlex3 = motion.create(Flex);
...
function Iframe(props) {
  var _a, _b;
  const { document: document2, options } = props, draft = document2.draft || document2.published || document2.displayed, { defaultSize = DEFAULT_SIZE, reload, attributes, showDisplayUrl = true, key: key2 } = options, basePath = ((_b = (_a = useActiveWorkspace()) == null ? void 0 : _a.activeWorkspace) == null ? void 0 : _b.basePath) || "/", urlRef = (0, import_react5.useRef)(options.url), [draftSnapshot, setDraftSnapshot] = (0, import_react5.useState)(() => ({ key: key2, draft }));
  (0, import_react5.useEffect)(() => {
    urlRef.current = options.url;
  }, [options.url]), (0, import_react5.useEffect)(() => {
    JSON.stringify({ key: key2, draft }) !== JSON.stringify(draftSnapshot) && startTransition2(() => setDraftSnapshot({ key: key2, draft }));
  }, [draft, draftSnapshot, key2]);
  const currentUser = useCurrentUser(), client = useClient({ apiVersion: "2023-10-16" }), [expiresAt, setExpiresAt] = (0, import_react5.useState)(), previewSecretRef = (0, import_react5.useRef)(void 0), [isResolvingUrl, startTransition2] = (0, import_react5.useTransition)(), { perspectiveStack, selectedPerspectiveName } = usePerspective(), perspective = (0, import_react5.useMemo)(
    () => ({
      perspectiveStack,
      selectedPerspectiveName
    }),
    [perspectiveStack, selectedPerspectiveName]
  ), url = (0, import_react5.useCallback)(
    ...
    async (draft2) => {
      ...
      if (typeof urlProp == "object") {
        ...
        if (!previewSecretRef.current) {
          ...
          previewSecretRef.current = secret, startTransition2(() => setExpiresAt(expiresAt2.getTime()));
        }
  ...
  return (0, import_react5.useEffect)(() => {
    if (expiresAt) {
      const timeout = setTimeout(
        () => {
          startTransition2(() => setExpiresAt(void 0)), previewSecretRef.current = void 0;
        },
        Math.max(0, expiresAt - Date.now())
      );
      return () => clearTimeout(timeout);
    }
  }, [expiresAt]), (0, import_jsx_runtime3.jsx)(import_react5.Suspense, { fallback: (0, import_jsx_runtime3.jsx)(Loading, { iframeSize: "desktop" }), children: (0, import_jsx_runtime3.jsx)(
    IframeInner,
    {
...
var IframeInner = (0, import_react5.memo)(function(props) {
  const {
    isResolvingUrl,
    ...
    _key
  } = props, [iframeSize, setIframeSize] = (0, import_react5.useState)((sizes == null ? void 0 : sizes[defaultSize]) ? defaultSize : DEFAULT_SIZE), prefersReducedMotion = usePrefersReducedMotion(), url = suspend(
  ...
  ), [loading, setLoading] = (0, import_react5.useState)(true), [_reloading, setReloading] = (0, import_react5.useState)(false), reloading = _reloading || isResolvingUrl, iframe = (0, import_react5.useRef)(null), handleReload = (0, import_react5.useCallback)(() => {
    (iframe == null ? void 0 : iframe.current) && (iframe.current.src = iframe.current.src, setReloading(true));
  }, []);
  return (0, import_jsx_runtime3.jsx)(MotionConfig, { transition: prefersReducedMotion ? { duration: 0 } : void 0, children: (0, import_jsx_runtime3.jsxs)(Flex, { direction: "column", style: { height: "100%" }, children: [
    (0, import_jsx_runtime3.jsx)(
      Toolbar,
      {
        url,
    ...
    url instanceof Error ? (0, import_jsx_runtime3.jsx)(ErrorCard, { error: url }) : (0, import_jsx_runtime3.jsx)(Card, { tone: "transparent", style: { height: "100%" }, children: (0, import_jsx_runtime3.jsx)(
      Frame,
      {
        ref: iframe,
        loading,
...
var Frame = (0, import_react5.forwardRef)(function(props, iframe) {
  ...
  return (0, import_jsx_runtime3.jsxs)(Flex, { align: "center", justify: "center", style: { height: "100%", position: "relative" }, children: [
    (0, import_jsx_runtime3.jsx)(AnimatePresence, { children: !url || loading && (0, import_jsx_runtime3.jsx)(
      MotionFlex3,
      {
        initial: "initial",
        animate: "animate",
        ...
        children: (0, import_jsx_runtime3.jsx)(Loading, { iframeSize })
      }
    ) }),
    url && (0, import_jsx_runtime3.jsx)(
      motion.iframe,
      {
        ref: iframe,
        title: "preview",
...
function Loading({ iframeSize }) {
  return (0, import_jsx_runtime3.jsxs)(Flex, { style: { ...sizes[iframeSize] }, justify: "center", align: "center", direction: "column", gap: 4, children: [
    (0, import_jsx_runtime3.jsx)(Spinner, { muted: true }),
    (0, import_jsx_runtime3.jsx)(Text, { muted: true, size: 1, children: "Loading…" })
  ] });
}
function ErrorCard({ error }) {
  return (0, import_jsx_runtime3.jsx)(Card, { height: "fill", children: (0, import_jsx_runtime3.jsx)(Flex, { align: "center", height: "fill", justify: "center", padding: 4, sizing: "border", children: (0, import_jsx_runtime3.jsx)(Container, { width: 0, children: (0, import_jsx_runtime3.jsx)(Card, { padding: 4, radius: 2, shadow: 1, tone: "caution", children: (0, import_jsx_runtime3.jsxs)(Flex, { children: [
    (0, import_jsx_runtime3.jsx)(Box, { children: (0, import_jsx_runtime3.jsx)(Text, { size: 1, children: (0, import_jsx_runtime3.jsx)(WarningOutlineIcon, {}) }) }),
    (0, import_jsx_runtime3.jsxs)(Stack, { flex: 1, marginLeft: 3, space: 3, children: [
      (0, import_jsx_runtime3.jsx)(Text, { as: "h1", size: 1, weight: "bold", children: error.name }),
      (0, import_jsx_runtime3.jsx)(Text, { as: "p", muted: true, size: 1, children: error.message })
    ] })
  ] }) }) }) }) });
}
