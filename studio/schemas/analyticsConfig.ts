  ...
  fields: [
    ...
    defineField({
      ...
      fields: [
        ...
        {
          name: 'script',
          title: 'Zoho Lead Tracking Script',
          type: 'text',
          description: 'Paste your Zoho ZFAdvLead tracking script here (the full <script>...</script> content). This will be injected on every page after the page loads.',
          hidden: ({ parent }) => !parent?.enabled,
          rows: 10,
        },
      ],
