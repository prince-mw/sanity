      ...
      of: [
        // Hero Section
        {
          ...
          preview: {
            ...
            prepare: ({title, media}) => ({title: title || 'Hero Section', subtitle: 'Hero', media}),
          },
        },
        // Text Block
        {
        ...
        // Two Column Section
        {
          ...
          preview: {
            ...
            prepare: ({title, media}) => ({title: title || 'Two Column', subtitle: 'Image + Text', media}),
          },
        },
        // Feature Grid
        {
        ...
        // Video Embed
        {
          ...
          preview: {
            ...
            prepare: ({title, media}) => ({title: title || 'Video Embed', subtitle: 'Video', media}),
          },
        },
        // Image Gallery
        {
        ...
        // CTA Banner
        {
          ...
          preview: {
            select: {title: 'heading', media: 'backgroundImage'},
            prepare: ({title, media}) => ({title: title || 'CTA Banner', subtitle: 'Call to Action', media}),
          },
        },
        // Pricing Table
        {
        ...
        // Contact Form
        {
          ...
          preview: {
            ...
            prepare: ({title, formType}) => ({title: title || 'Contact Form', subtitle: formType || 'Form'}),
          },
        },
        // Spacer / Divider
        {
        ...
        // Custom HTML/Embed
        {
          ...
          preview: {
            select: {title: 'title'},
            prepare: ({title}) => ({title: title || 'Custom Embed', subtitle: 'HTML/Embed'}),
          },
        },
      ],
    }),
